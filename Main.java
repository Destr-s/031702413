...
public class Main {
    ...
    private static final String myFirstAddress=
            "北京|天津|河北|山西|辽宁|吉林|黑龙江|上海|江苏|浙江|安徽|福建|江西|山东|河南|湖北|湖南|广东|海南|重庆|四川|贵州|云南|陕西|甘肃|青海";
    private static final String mysecondAdress=
    ...
    private String myThirdAddress="区|县|市";
    private String myForthAddress="街道|镇|乡";
    private String myFifthAddress="路|街|巷|胡同|道";
    private String mySixthAddress="号|弄";
    private  void setName(String _name){
        name=_name;
    }
    private  void setPhoneNumber(String s0)
    {
        phoneNumber=s0;
    }
    private void init(){
    ...
    private  Main getFirstAddress(Main res){
        String first="";
    ...
    private  Main getSecondAddress(Main res){
